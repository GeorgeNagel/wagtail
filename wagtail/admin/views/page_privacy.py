...
def set_privacy(request, page_id):
    ...
    if restrictions:
        # it is possible that restrictions exist on the ancestor, this page, or both
        restriction = restrictions.last()
        ancestor_with_restriction = None
        if restrictions[0] == page:
            ancestor_with_restriction = None
            restriction_exists_on_ancestor = False
        else:
            ancestor_with_restriction = restrictions[0]
            restriction_exists_on_ancestor = True
    else:
        restriction = None
        restriction_exists_on_ancestor = False
    ...
    if restriction_exists_on_ancestor:
        ...
        return render_modal_workflow(
            ...
            {
                'page_with_restriction': ancestor_with_restriction.page,
                'page': page,
                'form': form,
